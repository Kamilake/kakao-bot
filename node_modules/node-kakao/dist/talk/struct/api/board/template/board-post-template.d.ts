...
export declare type BoardPostFileMap = {
    [name: string]: string;
};
...
export declare type BoardPostTemplates = BoardTextPostTemplate | BoardImagePostTemplate | BoardVideoPostTemplate | BoardFilePostTemplate | BoardPollPostTemplate | BoardSchedulePostTemplate;
